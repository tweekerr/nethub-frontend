...
const _api = axios.create({
  ...
  baseURL:
    process.env.REACT_APP_GENERAL_BACK_POINT || ' https://nethub.loca.lt/v1',
});

const token =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJJZCI6IjMiLCJVc2VybmFtZSI6InR3ZWVrZXIiLCJuYmYiOjE2NTY2ODIwNTcsImV4cCI6MTY1Njc1MTU5NywiaWF0IjoxNjU2NjgyMDU3fQ.9t007ZJe8p9Xtfg7mCKLJov460_x8Xa7z7SVSViTfsU';
